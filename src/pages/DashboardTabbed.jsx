                ...
                <div className="w-full mt-6">
                    <div>
                        <ul className="flex border-b">
                            <TabLink tabNumber={1} openTab={openTab} setOpenTab={setOpenTab}>Tab 1</TabLink>
                            <TabLink tabNumber={2} openTab={openTab} setOpenTab={setOpenTab}>Tab 2</TabLink>
                            <TabLink tabNumber={3} openTab={openTab} setOpenTab={setOpenTab}>Tab 3</TabLink>
                            <TabLink tabNumber={4} openTab={openTab} setOpenTab={setOpenTab}>Tab 4</TabLink>
                        </ul>
                    </div>
